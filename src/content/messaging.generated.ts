// AUTO-GENERATED by @obsunified/messaging sync — do not edit.
// Source of truth: obs-unified/packages/messaging/manifest.json
export const messaging = {
	"$note": "DO NOT EDIT the `derived` block by hand — run `pnpm --filter @obsunified/messaging generate`. The `authored` block is hand-maintained.",
