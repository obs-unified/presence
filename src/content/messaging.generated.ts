// AUTO-GENERATED by @obs-unified/messaging sync — do not edit.
// Source of truth: obs-unified/packages/messaging/manifest.json
export const messaging = {
	"$note": "DO NOT EDIT the `derived` block by hand — run `pnpm --filter @obs-unified/messaging generate`. The `authored` block is hand-maintained.",
	...
	"derived": {
		...
		"packages": [
			{
				"name": "@obs-unified/agents-langgraph",
			...
			{
				"name": "@obs-unified/agents-vercel-ai",
				"registry": "https://registry.npmjs.org/",
				"scope": "@obs-unified",
			...
			{
				"name": "@obs-unified/pprof-decoder",
				"registry": "https://registry.npmjs.org/",
				"scope": "@obs-unified",
	...
	"authored": {
		...
		"slug": "obs-unified",
		"identityChain": "user_id → session_id → interaction_id → trace_id → span_id → action_id",
		"devIngestKey": "dev-ingest-key",
		"positioning": {
			"hero": {
				"headline": "A telemetry graph agents can actually debug with.",
				"subhead": "Debug AI agents, and help AI agents debug software.",
				"primaryProofImage": "/screenshots/app/agent-action-graph.png"
			},
			"proof": {
				"identityChain": "user_id → session_id → interaction_id → trace_id → span_id → action_id",
				"clickToActionCpuExample": "A click mints one interaction_id. Backend spans, logs, AI calls, action graphs, MCP tools, and CPU profiles join through the resulting trace.",
				"deterministicEvidence": "Evidence references, Connected Rail pivots, CCR bundles, retrieval refs, and profile joins are deterministic structured data. LLMs can summarize the evidence, but they are optional consumers, not the source of truth."
			},
			"differentiator": {
				"ccr": "Compressed context retrieval — the evidence retrieval layer (RFC 0011).",
				"mcp": "MCP investigation server",
				"evidenceRefs": "Agent-readable evidence references",
				"actionGraph": "Agent Action Graph"
			},
			"distribution": {
				"license": "MIT",
				"hosting": "Self-host on your infra",
				"docker": "Start locally with one Docker image",
		...
		"glossary": {
			...
			"@obsunified": "Hyphen-less npm scope for the public MCP server package only.",
